...
public class Product implements Serializable {
    ...
    public Product(Category category, String vendorCode, List<ProductImage> images, String title, String shortDescription, String fullDescription, double price, LocalDateTime createAt, LocalDateTime updateAt) {
